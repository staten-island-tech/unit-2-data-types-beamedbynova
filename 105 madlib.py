...
if quizStart == "Yes":
    disclaimer = input("Disclaimer: the answers in this quiz do not have to be accurate. There are no 'wrong' answers when it comes to this quiz, so you may answer however you want. Type 'I understand' to continue. ")
    if disclaimer == "I understand":
        ...
        washingtonSpecies = input("What is Washington? (respond with a noun, do not use 'a') ")
        ...
        Madlib = f"When Washington was a young " + washingtonSpecies + " (about " + washingtonAge + " years old), his " + washingtonFather + " father gifted him a very sharp " + washingtonGift + ". 'Wow! What a sharp " + washingtonGift + "!' Washington exclaims, stunned as he looks at the gift in his hands. Washington's father was happy to see his son satisfied with his gift, and he left the room to go cook some food. Washington was so eager to use his new " + washingtonGift + " that he walked right out of his " + washingtonHouse + " without letting his father know! As he walked around the wilderness surrounding his " + washingtonHouse + ", he wondered what he could test his brand new " + washingtonGift + " on. Eventually, something catches his eye: A humble " + tree + " tree that even a " + washingtonAge + " year old could cut down! Washington clutches his " + washingtonGift + " in his hand and takes a mighty swing at the " + tree + " tree. BANG! The " + washingtonGift + " crashes into the " + tree + " tree, leaving a nasty "
